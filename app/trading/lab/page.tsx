...
const IDS=["breakout_asia","ema_cross","rsi_meanrev"] as const;
...
export default function LabPage(){
  ...
  return (
    <div className="wrap" id="main">
      <header>
        <div>
          <h1><FlaskConical size={20} style={{display:"inline",verticalAlign:"-3px",marginRight:6}}/>Backtest Lab <span className="dot">XAUUSD M15</span></h1>
          <div className="sub">Mock 1 ปี · 3 กลยุทธ์ · Monte Carlo 1000 sims · daily-PnL correlation</div>
        </div>
      ...
      <div className="cards-sec">
        <h2><TrendingUp/> Metrics <span className="tag">{IDS.length} strategies</span></h2>
      ...
      <div className="cards-sec">
        <h2><Shuffle/> Monte Carlo <span className="tag">p05 / median / p95 · ruin</span></h2>
        <div style={{overflowX:"auto"}}>
        <table>
      ...
      <div className="cards-sec">
        <h2><Grid3X3/> Correlation <span className="tag">daily PnL · 3×3</span></h2>
      ...
      <footer>Backtest Lab · mock XAUUSD M15 · <Link href="/trading">→ Trading Dashboard</Link></footer>
    </div>
  );
}
