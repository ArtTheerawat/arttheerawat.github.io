...
interface HideButtonProps {
  ...
  compact?: boolean;
  /** When true, clicking opens the hide flow. When false (guest or non-owner),
   *  renders nothing — only the approved owner may hide, enforced by RLS. */
  canEdit?: boolean;
}

/** Small hide button (🙈 ไม่ต้องทำแล้ว) that opens the confirmation modal.
 *  When !canEdit, renders nothing (the caller decides access). */
export function HideButton({ assignment, onHide, compact, canEdit = true }: HideButtonProps) {
